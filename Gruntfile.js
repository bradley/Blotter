  ...
  grunt.initConfig({
    ...
    meta: {
      ...
      srcFiles : [
        ...
        'src/builders/texture_builders/_textTextureBuilder.js',
        'src/builders/texture_builders/_indicesDataTextureBuilder.js',
        'src/builders/texture_builders/_boundsDataTextureBuilder.js',
        'src/builders/_mappingBuilder.js',
        'src/builders/_mapping.js',
        'src/builders/_mappingMaterial.js',
        'src/builders/_mappingMaterialBuilder.js',
